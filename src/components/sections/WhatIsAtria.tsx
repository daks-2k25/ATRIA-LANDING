...
const dayToDay = [
  ...
  { icon: Tv, label: "Financeiro" },
  { icon: Search, label: "Busca de Leads" },
  { icon: Bell, label: "Contratos" },
  { icon: Bell, label: "Propostas" },
  { icon: Bell, label: "Customização" },
  { icon: Bell, label: "Aprovação interna" },
  { icon: Bell, label: "Portal do Cliente" },
];
        ...
        <div>
          ...
          <Reveal delay={0.16} className="mt-5 max-w-md">
            <p className="text-[15px] leading-relaxed text-text-muted">
              Atria ajuda agências a organizar o dia a dia com clientes:
              produzir conteúdo, acompanhar tarefas, controlar finanças,
              prospectar leads e oferecer um portal onde o cliente aprova
              trabalhos e vê resultados.
            </p>
          </Reveal>
        </div>
